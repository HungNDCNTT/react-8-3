...
const messages = [
    "Gửi tới bạng iuuu mấy tỷ nụ hôn tình thương mến thương 😘😘😘😘😘",
    "Chúc bạng iuu Péo ú hay ăn chóng nhớn càng ngày càng xing tươi 🐷🐷🐷",
    "Chúc em tiền vào đầy túi rủng già rủng rỉnh 🤑💵💴💶💷💰💲💸",
    "Chúc em ngày nào cũng vui vẻ, cười hở 10 tỷ cái răng 🤣🤣🤣🤣",
    "Chúc em công việc thuận lợi, ngày nào đi làm cũng như đi chơi beng beng beng bèng beng béng beng 🐎🐉🐲🐌",
    "Cuối cùng, Chúc em sẽ mãi luôn có anh đồng hành cùng em 😆😎😎"
];
